...
def fetch_missions_data():
    list_of_missions = ["STS-40", "Biosatellite%20III","Biosatellite%20II", "Cosmos%20782","Cosmos%20936", "Cosmos%201514", "Cosmos%201129","Cosmos%201667","Cosmos%201887", "SpaceX-19","SpaceX-21","SpaceX-23","SpaceX-22"]
...
def load_mission_data(concatenated_dataframe):
    ...
    schema_name = 'NASA_Missions'
    table_name = 'my_nasa_mission'

    try:
        #Creating engine from create_engine of sqlalchemy
        engine = create_engine("postgresql://tsandil:stratocaster@127.0.0.1:5432/my_database3")
